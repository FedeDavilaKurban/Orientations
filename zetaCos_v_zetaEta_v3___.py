...
ax5.set_xlabel(r'$\zeta_{cos}=(\langle \cos\rangle -\langle \cos\rangle_\mathrm{ran})/\sigma_{\cos\mathrm{,ran}}}$')
ax5.set_ylabel(r'$\zeta_{\eta}=(\langle\eta\rangle-\langle\eta\rangle_\mathrm{ran})/\sigma_{\eta\mathrm{,ran}}}$')
#ax5.set_xlim([-.35,.14])
plt.tight_layout()
