...
for Nran in Nrans:   
    ...
    ax.plot(np.linspace(2.,5.5,100),np.linspace(2.,5.5,100),color='k',ls='--')
    ax.fill_between(np.linspace(2.,5.5,100),np.linspace(2.,5.5,100)-db,\
        np.linspace(2.,5.5,100)+db,color='k',alpha=.5)
