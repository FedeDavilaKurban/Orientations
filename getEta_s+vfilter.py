        ...
        for sec in [0,123,456,14,36,4,6,1,3]:
            ...
            for vtype in ['a','r','s']:
                ...
                for rmin,rmax in zip(r1,r2):
                    ...
                    v_p50 = np.percentile(vrad,50)
                    s_p50 = np.percentile(sigma5,50)
                    
                    if (vfilter=='hi')&(sfilter=='hi'): 

                        beta = beta[(vrad>v_p50)&(sigma5>s_p50)]

                    elif (vfilter=='hi')&(sfilter=='lo'): 

                        beta = beta[(vrad>v_p50)&(sigma5<s_p50)]

                    elif (vfilter=='lo')&(sfilter=='lo'): 

                        beta = beta[(vrad<v_p50)&(sigma5<s_p50)]

                    elif (vfilter=='lo')&(sfilter=='hi'): 
                ...
                if r1==[.9]: 
                    ...
                    filename = '../data/eta/eta_sfilter{}_vfilter{}_minradV{}_maxradV{}_sec{}_vtype{}.txt'\
                        .format(sfilter,vfilter,minradV,maxradV,sec,vtype)
