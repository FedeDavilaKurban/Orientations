...
Modificacion que aniade plots para ver data sobre sigma
"""
#---------------------------------
...
Plots
"""
ax = plt.subplot2grid((5, 5), (0, 0))
plt.tight_layout()
plt.suptitle('Void{}'.format(nv),size=14)

ax1 = plt.subplot2grid((6, 6), (0, 0), colspan=3, rowspan=2)
ax2 = plt.subplot2grid((6, 6), (3, 0), colspan=3, rowspan=2)
ax3 = plt.subplot2grid((6, 6), (0, 3), colspan=3, rowspan=2)
ax4 = plt.subplot2grid((6, 6), (3, 3), colspan=3, rowspan=2)
 
ax5 = plt.subplot2grid((6, 6), (2, 0), colspan=3)
ax7 = plt.subplot2grid((6, 6), (2, 3), colspan=3)
ax6 = plt.subplot2grid((6, 6), (5, 0), colspan=3)
ax8 = plt.subplot2grid((6, 6), (5, 3), colspan=3)
#plt.show()
...
for plot,subplot in [(ax1,ax5),(ax2,ax6),(ax3,ax7),(ax4,ax8)]: 
