...
plt.figure(2,dpi=100)#figsize=(20,10),dpi=100)

plt.xlabel('$log_{10}(M/M_{\odot})$',fontsize=16)
plt.ylabel('$log_{10}(Spin)\,\, [(kpc/h)(km/s)]$',fontsize=16)
plt.scatter(M,S,c=seaborn.color_palette()[1],label='Low Spin Galaxies')
plt.scatter(np.log10(gals_h['mass']),np.log10(gals_h['sp_n']),label= 'High Spin Galaxies')
