...
#%%
fig , ax = plt.subplots(nrows = 2, ncols = 3, sharex=True, sharey=True, figsize=(9,6))
...
for i in range(0,2):
    for j in range(0,3):
        ...
        exp, minradV, rmin, rmax, sec, fxa, vtype = readExp('sec_'+id_str)
...
plt.tight_layout()
plt.savefig('../plots/paper/sec.png')
